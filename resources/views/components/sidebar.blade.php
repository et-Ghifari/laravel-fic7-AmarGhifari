        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown {{ $type_menu === 'forms' ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown"><i class="far fa-file-alt"></i>
                    <span>Forms</span></a>
                <ul class="dropdown-menu">
                    <li class="{{ Request::is('advanced-form') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ url('advanced-form') }}">Advanced Form</a>
                    </li>
                    <li class="{{ Request::is('editor') ? 'active' : '' }}">
            ...
            <li class="nav-item dropdown {{ $type_menu === 'auth' ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ Request::is('login2') ? 'active' : '' }}">
                        <a class="beep beep-sidebar" href="{{ url('login2') }}">Login 2</a>
                    </li>
